...
export const IN_SHORT_LIST = {
  ...
  list: [
    ...
    'Open Science: 150+ public repositories released',
  ],
};
...
export const COMPLEMENTING = {
  ...
  paragraphs: [
    'While simulation neuroscience is a powerful tool, it comp-lements rather than replaces experimental and theoretical approaches.',
  ...
  image: '/images/about/long_foot_image.png',
};
