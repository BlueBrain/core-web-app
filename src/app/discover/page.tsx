...
export default function Discover() {
  return (
    <div className={classNames('relative bg-primary-9 h-full')}>
      ...
      <div className="fixed top-[130px] left-[53px] max-w-[250px] w-full z-[1]">
      ...
      <div className="absolute h-[calc(100vh-56px)] top-7 right-7 flex justify-end w-3/5 ml-auto z-[2]">
