...
export default function GenerateMovieModal() {
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="bg-black fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 p-5 text-white">
        ...
        <Dialog.Close asChild>
          <button className="absolute top-3 right-3 text-white/50" aria-label="Close">
            <CloseIcon />
          </button>
        </Dialog.Close>
      </Dialog.Content>
