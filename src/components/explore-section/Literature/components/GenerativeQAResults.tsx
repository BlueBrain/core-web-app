        ...
        <div id={id} className={`w-full mt-3 ${collpaseQuestion ? 'mb-6' : 'mb-28'}`} ref={answerRef}>
            ...
            <div className='inline-flex items-center justify-between w-full'>
                <div className="inline-flex items-center justify-start w-full gap-2 my-5">
                    <BrainLight />
                    <span className={`font-normal tracking-tight text-blue-900 ${collpaseQuestion ? 'text-xl font-extrabold' : 'text-sm'}`}>
                        {question}
                    </span>
                </div>
                <button
                ...
                >
                    <ChevronIcon fill="#003A8C" className={`${collpaseQuestion ? 'rotate-0' : 'rotate-90'}`} />
                </button>
            </div>
                ...
                <div className={`w-full ${showExtraDetails ? '' : 'hidden'}`}>
                    <div className="inline-flex items-center justify-between w-full gap-y-3">
                        ...
                        >
                            ...
                            <ChevronIcon fill="#003A8C" className={`${expandArticles ? '-rotate-90' : 'rotate-90'}`} />
                        </button>
                        <button
                            type="button"
