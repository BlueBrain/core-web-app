...
function QASingleResult({
    ...
    return (
      <li
        id={id}
        className={`last:mb-40 w-full mt-3 ${collpaseQuestion ? 'mb-6' : 'mb-28'}`}
        ref={answerRef}
      >
        ...
        <div className="inline-flex items-center justify-between w-full">
          <div className="inline-flex items-center justify-start w-full gap-2 my-5">
            <BrainLight />
            <span
              className={`font-normal tracking-tight text-blue-900 ${collpaseQuestion ? 'text-xl font-extrabold' : 'text-sm'
                }`}
            >
              {question}
            </span>
