...
*/
export async function fetchSimCampWorkflowConfig(simCampaign: Simulation, session: Session | null) {
...
*/
export function useAnalysisIds(resource: Simulation): [string[], boolean] {
