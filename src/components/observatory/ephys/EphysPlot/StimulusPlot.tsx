...
import { convertAmperes, Amperes } from '@/util/observatory/plotHelpers';
import optimizePlotData from '@/util/observatory/optimizeTrace';
import useConfig from '@/components/observatory/ephys/useConfig';
import { PlotProps } from '@/types/observatory/index';
