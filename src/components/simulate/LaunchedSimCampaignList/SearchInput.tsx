...
import { searchLaunchedSimCampStringAtom } from '@/state/simulate';

export default function SearchInput() {
  const setSearchString = useSetAtom(searchLaunchedSimCampStringAtom);
  ...
  return (
    <input
      ...
      placeholder="Search simulation campaigns..."
