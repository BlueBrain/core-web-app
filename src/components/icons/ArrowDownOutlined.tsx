...
export default function ArrowDownOutlinedIcon({ className, style }: ArrowDownOutlinedIconProps) {
  return (
    <svg
      className={className}
      style={style}
