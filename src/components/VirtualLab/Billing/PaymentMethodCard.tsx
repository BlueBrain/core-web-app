...
export default function PaymentMethodCard({ id, cardholderName, cardNumber, virtualLabId }: Props) {
  ...
  return (
    <div
      id={id}
      className="flex w-full items-center justify-between gap-5 rounded-md border border-neutral-3 p-5 text-primary-7 hover:bg-gray-100"
    >
