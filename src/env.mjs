...
export const env = createEnv({
  ...
  client: {
    ...
    NEXUS_PUBLIC_DEFAULT_ORG: z.string().min(1),
    NEXUS_PUBLIC_DEFAULT_PROJECT: z.string().min(1),

    NEXT_PUBLIC_BBS_ML_BASE_URL: z.string().url(),
    NEXT_PUBLIC_BLUE_NAAS_DEPLOYMENT_URL: z.string().url(),
  ...
  experimental__runtimeEnv: {
    ...
    NEXUS_PUBLIC_DEFAULT_ORG: process.env.NEXUS_PUBLIC_DEFAULT_ORG,
    NEXUS_PUBLIC_DEFAULT_PROJECT: process.env.NEXUS_PUBLIC_DEFAULT_PROJECT,

    NEXT_PUBLIC_BBS_ML_BASE_URL: process.env.NEXT_PUBLIC_BBS_ML_BASE_URL,
    NEXT_PUBLIC_BLUE_NAAS_DEPLOYMENT_URL: process.env.NEXT_PUBLIC_BLUE_NAAS_DEPLOYMENT_URL,
    ...
    NEXT_PUBLIC_ONTOLOGY_BASE_URL: process.env.ONTOLOGY_BASE_URL,

    NEXT_PUBLIC_NEUROSHAPES_BASE_URL: process.env.NEUROSHAPES_BASE_URL,
